...
-- changeset PRLNU:1753338759370 stripComments:false  logicalFilePath:milestone-1/prlnu/package_bodies/eba_cust.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/prlnu/package_bodies/eba_cust.sql:null:ef8150558aae52ae9128210931ab117f62641a79:create
...
create or replace package body eba_cust as
    ...
    begin
        ...
        if eba_cust_fw.get_preference_value('ACCESS_CONTROL_ENABLED') = 'N' then
            ...
            if
                l_access_level_id = 1
                and eba_cust_fw.get_preference_value('ACCESS_CONTROL_SCOPE') = 'PUBLIC_CONTRIBUTE'
            then
                return 2;
            end if;
    ...
    begin
        ...
        for c1 in (
            ...
            where
                authorization_name = p_authorization_name
        ) loop
    ...
    begin
        ...
        if l_count >= 1 then
            ...
            insert into eba_cust_views_log (
                view_type,
                table_primary_id
            ) values ( p_view_type,
                       p_id );
