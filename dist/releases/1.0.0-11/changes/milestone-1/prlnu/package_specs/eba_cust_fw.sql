...
-- changeset PRLNU:1753338765309 stripComments:false  logicalFilePath:milestone-1/prlnu/package_specs/eba_cust_fw.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/prlnu/package_specs/eba_cust_fw.sql:null:bdcd1295f94d82a10b92b210a4e445adf029ea28:create

create or replace package eba_cust_fw as
